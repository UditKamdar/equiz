...
module.exports = function (req, res) {
    ...
    var c = []
    connection.query('select quiz_no from quiz where class_id = ?', [i.class_id], function (error, results, fields) {
        ...
        connection.query('INSERT INTO quiz SET ?', c, function (error, results, fields) {
            ...
            // res.sendfile('public/index.html');
                ...
                connection.query('SELECT quiz_id,total_marks FROM quiz WHERE class_id = ?', [i.class_id], function (error, results, fields) {
                    if (error) throw error;
                    else {
                        module.exports = {
