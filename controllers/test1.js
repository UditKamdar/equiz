...
module.exports = function (req, res) {
    ...
    var i = require('./s_quiz1.js');
    var m = require('./authenticate_controller.js');
    var code = require('./s_view_classroom.js');
    var b= require('./s_quiz1.js');
    var a = []
    // var q = {
    ...
    connection.query('select class_id from classroom where classroom_code = ?', [code.classroom_code], function (error, results, fields) {
        ...
        // res.sendfile('public/index.html');
            ...
            connection.query('SELECT quiz_id FROM quiz WHERE class_id = "' + [temp] + '" and quiz_no = "' + [b.quiz_no] + '"', function (error, results, fields) {
                if (error) throw error;
                else {
                    // module.exports = {
